...
2. Clique no botão **I'm feeling lucky**. O plugin executará os passos da interface de forma automatizada:
* Carrega as topologias selecionadas (**Step 1**).
...
* `protein_clean_autopsf.psf`: Contém todos as informações necessárias para aplicar o campo de força.
