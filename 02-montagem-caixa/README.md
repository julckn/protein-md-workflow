...
> [!CAUTION]
> **Erro de Conectividade:** Arquivos vindos de servidores externos (PDB2PQR) podem conter geometrias de hidrogênio que o VMD interpreta incorretamente, gerando o erro fatal `Maximum of 12 bonds` (também exibido como `too many bonds in bondlist`). 
