...
* [**03-configuracao-namd**](./03-configuracao-namd): Edição do arquivo `.conf`. Definição de parâmetros físicos (tempo, temperatura e pressão) e inserção das dimensões da caixa.
